...
//			}
	...
	register_deactivation_hook( __FILE__, 'ma_el_welcome_deactivate' );
	...
	// Deactivation Hook
	if( !function_exists('ma_el_welcome_deactivate')){
		function ma_el_welcome_deactivate() {

			if(ma_el_fs()->can_use_premium_code()){
				$dependent = 'master-addons/master-elementor-addons.php';
				if( is_plugin_active($dependent) ){
					add_action('update_option_active_plugins', 'ma_el_plugin_independent');
				}
			}
	...
	if( !function_exists('ma_el_welcome_deactivate')) {
		function ma_el_plugin_independent() {
			$dependent = 'master-addons/master-elementor-addons.php';
